...
public class OrderDataMapper {
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand) {
        return Order.builder()
                ...
                .items(orderItemToOrderItemEntities(createOrderCommand.getOrderItems()))
                .build();
    }
    ...
    private List<OrderItem> orderItemToOrderItemEntities(List<com.food.ordering.system.order.service.domain.dto.create.OrderItem> orderItems) {
